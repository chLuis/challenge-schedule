  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-blue-500 text-slate-50 hover:bg-blue-900 hover:text-slate-100 focus:bg-blue-500 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-200 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
