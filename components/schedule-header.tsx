...
export const ScheduleHeader = () => {
  ...
  return (
    <header className="relative flex gap-4 font-semibold items-center bg-white z-40 col-span-12 mx-6 pb-2 text-center">
      ...
      <h2 className="text-black/80 flex items-center justify-center h-full mt-8">
        <PencilLineIcon className="stroke-1 me-2 min-w-6" /><span>Book Your Appointment Below</span></h2>
    </header>
  );
};
